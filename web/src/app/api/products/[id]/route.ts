...
import { parseProductPatch } from "@/src/lib/server/products-validation";
import * as repo from "@/src/lib/server/repositories/products";
...
export async function GET(request: NextRequest, props: Props) {
  ...
  try {
    ...
    if (!item) return notFound("Product");
