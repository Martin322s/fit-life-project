...
const FAQ_ITEMS: FaqEntry[] = [
    ...
    },
    {
        ...
        answer: (
            <p>
                Да. Можеш да поискаш изтриване на акаунта си чрез контактната форма. При
    ...
    },
    {
        ...
        answer: (
            <p>
                ...
                съставки. Следи <Link href="/contact">нашия Newsletter</Link> за обновления.
            </p>
        ),
    },
    ...
    },
    {
        ...
        answer: (
            <p>
                ...
                Можеш да поискаш пълен export чрез контактната форма. Данните се изпращат
        ...
        answer: (
            <>
                ...
                <p style={{ marginTop: 12 }}>
                    ...
                    <Link href="/contact">свържи се с нас</Link> и ще решим ситуацията.
                </p>
            </>
        ),
    },
