                    ...
                    <div style={{ maxWidth: 760, margin: "0 auto", display: "flex", flexDirection: "column", gap: "var(--space-xl)" }}>
                        ...
                        <div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-sm)" }}>
                                {[
                                    ...
                                    { right: "Право на изтриване", desc: "Можеш да поискаш изтриване на акаунта си чрез контактната форма." },
                        ...
                        <div>
                            ...
                            <p className="body-md text-gray">
                                ...
                                <Link href="/cookies" style={{ color: "var(--color-mustard)" }}>Политика за бисквитки</Link>.
                            </p>
                        </div>
