        ...
        return (
            <main className="login-form-panel">
                <div className="login-form-inner" style={{ textAlign: "center", paddingTop: "var(--sp-8)" }}>
                    ...
                    <Link href="/forgot-password" className="btn-primary btn-full" style={{ textDecoration: "none" }}>
                        Заяви нов линк
                    </Link>
                </div>
            </main>
            ...
            <div className="login-form-inner">
                ...
                {success ? (
                    <div style={{ textAlign: "center", paddingTop: "var(--sp-4)" }}>
                        ...
                        <Link href="/login" className="btn-primary btn-full" style={{ textDecoration: "none" }}>
                            Влез в акаунта
                        </Link>
                    </div>
                ) : (
